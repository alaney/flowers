...
-- Started on 2023-02-08 17:14:31
...
-- Name: arrangements_hard_goods; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.arrangements_hard_goods (
    arrangement_id integer NOT NULL,
    hard_good_id integer NOT NULL
);


ALTER TABLE public.arrangements_hard_goods OWNER TO postgres;
...
--
-- TOC entry 3208 (class 2606 OID 16552)
...
--
-- TOC entry 3210 (class 2606 OID 16554)
...
--
-- TOC entry 3212 (class 2606 OID 16556)
...
--
-- TOC entry 3214 (class 2606 OID 16558)
...
--
-- TOC entry 3218 (class 2606 OID 16562)
-- Name: hard_goods hard_goods_unique_name; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hard_goods
    ADD CONSTRAINT hard_goods_unique_name UNIQUE (name);


--
-- TOC entry 3220 (class 2606 OID 16564)
...
--
-- TOC entry 3221 (class 1259 OID 16590)
-- Name: fki_arrangements_hard_goods_arrangement_id_fkey; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_arrangements_hard_goods_arrangement_id_fkey ON public.arrangements_hard_goods USING btree (arrangement_id);


--
-- TOC entry 3222 (class 1259 OID 16596)
-- Name: fki_arrangements_hard_goods_hard_good_id_fkey; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_arrangements_hard_goods_hard_good_id_fkey ON public.arrangements_hard_goods USING btree (hard_good_id);


--
-- TOC entry 3223 (class 2606 OID 16573)
...
--
-- TOC entry 3224 (class 2606 OID 16568)
...
ALTER TABLE ONLY public.arrangements_hard_goods
    ADD CONSTRAINT arrangements_hard_goods_arrangement_id_fkey FOREIGN KEY (arrangement_id) REFERENCES public.arrangements(id);


--
-- TOC entry 3226 (class 2606 OID 16591)
-- Name: arrangements_hard_goods arrangements_hard_goods_hard_good_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.arrangements_hard_goods
    ADD CONSTRAINT arrangements_hard_goods_hard_good_id_fkey FOREIGN KEY (hard_good_id) REFERENCES public.hard_goods(id);


-- Completed on 2023-02-08 17:14:32
